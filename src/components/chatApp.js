  ...
  return (
    <div className='project-description'>
      ...
      <p className='description'>
        ...
        The stack is Node JS and Express JS for the backend/API's, React JS for the frontend and the website is hosted on render.
      </p>
      <a href='https://mearnchatapp.onrender.com' target='_blank' >View Site</a>
      <a href='https://github.com/Nikita-Negi-03/MearnChatApp' target='_blank' >Github</a>
    </div>
  )
}
